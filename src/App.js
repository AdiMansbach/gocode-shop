...
function App() {
  ...
  useEffect (() => {
    ...
    .then((json) => {
      ...
      console.log('products useEffect '  + JSON.stringify(products))
      console.log('initialProducts useEffect '  + JSON.stringify(initialProducts))
  ...
  console.log('products after '  + JSON.stringify(products))
  console.log('initialProducts after '  + JSON.stringify(initialProducts))
