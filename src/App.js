...
function App() {
  ...
  const onChange = (category) => {
    if (category === 'All'){
        ...
        setProducts(productList.filter((product) => product.category === category));
    }
  }
