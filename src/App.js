...
import ProductDetails from './Viewes/ProductDetails';
...
function App() {
  ...
  const providerValue = { initialProducts, setProducts, productsInCart, setProductsInCart,  products, setInitialProducts};
